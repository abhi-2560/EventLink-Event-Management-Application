...
import Hero from '@registrant/components/event/Hero';
import SearchBar, { filtersToSearchParams } from '@registrant/components/event/SearchBar';
import EventGrid from '@registrant/components/event/EventGrid';
import EventCard from '@registrant/components/event/EventCard';
import { EventGridSkeleton } from '@registrant/components/event/EventCardSkeleton';
import HomeStats from '@registrant/components/event/HomeStats';
import WhyChooseSection from '@registrant/components/event/WhyChooseSection';
import HomeCta from '@registrant/components/event/HomeCta';
...
import { buildEventSearchFilters, hasActiveEventFilters } from '@registrant/utils/eventSearch';
import type { EventSearchFilters } from '@registrant/utils/eventSearch';
