...
import PaymentSummary, { PaymentSimulationCard } from '@registrant/components/payment/PaymentSummary';
import PaymentSuccess from '@registrant/components/payment/PaymentSuccess';
import { getRegistration } from '@registrant/api/registrationApi';
import { verifyPayment, failPayment, createPaymentOrder } from '@registrant/api/paymentApi';
import { useRegistration } from '@registrant/context/RegistrationContext';
import { showError, showSuccess } from '@shared/utils/toast';
import type { Payment as PaymentRecord } from '@shared/types/api';
import type { RegistrationFlowState } from '@registrant/context/RegistrationContext';
