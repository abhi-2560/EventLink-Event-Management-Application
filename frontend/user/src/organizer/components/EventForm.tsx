...
import Input, { Select, Textarea } from '@shared/components/common/Input';
import Button from '@shared/components/common/Button';
import { getCategories } from '@organizer/api/organizerApi';
import { eventSchema, formToEventPayload } from '@organizer/schemas/organizerSchemas';
import type { EventFormValues } from '@organizer/schemas/organizerSchemas';
...
interface EventFormProps {
  ...
  onSubmit: (_payload: ReturnType<typeof formToEventPayload>, _media: EventMediaUpload) => void | Promise<void>;
  loading: boolean;
  submitLabel?: string;
  showPublish?: boolean;
  onPublish?: (_payload: ReturnType<typeof formToEventPayload>, _media: EventMediaUpload) => void | Promise<void>;
  isEdit?: boolean;
  minCapacity?: number;
}
